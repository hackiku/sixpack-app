...
with_node \
  ...
  --target "/Users/jzro/code/products/sixpack/app/ios/Pods/Target Support Files/Pods-sixpack/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-asset" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-gl" "expo-keep-awake" "expo-router" "expo-sensors" "expo-system-ui" "expo-web-browser"
